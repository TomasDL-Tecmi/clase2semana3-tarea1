...
while True:
    ...
    # Opcion 3: Modificar algun elemento (nombre y precios)
    ...
    # Opcion 4: Modificar solo el precio de compra o venta de un elemento existente
    ...
    # Opcion 5: Finalizar edicion y pasar a la calculadora
    elif opcion in ["5", "finalizar"]:
        break
